 ...
 * under the License.
 */
package org.wso2.internal.apps.license.manager.impl.exception;

/**
 * Exceptions that may occur during the execution of the process.
 */
public class LicenseManagerRuntimeException extends Exception {
     ...
     */
    public LicenseManagerRuntimeException(String message) {
     ...
     */
    public LicenseManagerRuntimeException(String message, Throwable cause) {
