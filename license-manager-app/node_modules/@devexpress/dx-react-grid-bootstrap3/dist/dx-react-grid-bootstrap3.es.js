  ...
  createClass(TableView$$1, [{
    ...
    value: function render() {
      ...
      return React.createElement(TableView, _extends({
        ...
        tableStubHeaderCellTemplate: combineTemplates(tableStubHeaderCellTemplate, defaultStubHeaderCellTemplate),
  ...
  createClass(VirtualTableView, [{
    ...
    value: function render() {
      ...
      return React.createElement(TableView, _extends({
        ...
        tableStubHeaderCellTemplate: combineTemplates(tableStubHeaderCellTemplate, defaultStubHeaderCellTemplate$1),
